...
- [x] 应用开源/免费商用字体，当前 29+
- [x] 纹理修改，支持除自定义背景图片外的其他主题，当前 19+
- [x] 修改平台为尺寸，提供常用比例，如 1:1、16:9 等，当前 11+
- [x] 桌面和手机预览主题替换背景图为真机
...
- [中文网字计划](https://chinese-font.netlify.app/zh-cn/) 的免费CDN
- [ZeoSeven Fonts](https://fonts.zeoseven.com/) 的免费商用字体
